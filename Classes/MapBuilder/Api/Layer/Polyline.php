 ...
 * @api
 */
class Tx_AdGoogleMapsPluginPoly_MapBuilder_Api_Layer_Polyline extends Tx_AdGoogleMaps_MapBuilder_Api_Layer_AbstractLayer {
	 ...
	 * @return Tx_AdGoogleMapsPluginPoly_MapBuilder_Api_Layer_Polyline
	 */
